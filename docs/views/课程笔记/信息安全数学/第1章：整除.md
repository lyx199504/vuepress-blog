...
> 证明：(1) 假设有有限个形如$4k-1$的素数，不妨设为$p_1,\cdots,p_n$，令$K=4(p_1\cdots p_n)-1$，可知$K$不整除$2$和$p_i$，故$K$没有形如$4k-1$的素因子，因为形如$4k$和$4k+2$（$2$除外）的数必定是合数，又因为$(4k+1)\mathrm{mod}4=1$，即$(4k+1)^\alpha\mathrm{mod}4=1$，但$K\mathrm{mod}4=3$，故$K$没有素因子，即$K$也是素数，则形如$4k-1$的素数有无穷多个。<br>
> &emsp;&emsp;&emsp;(2) 假设有有限个形如$6k-1$的素数，不妨设为$p_1,\cdots,p_n$，令$K=6(p_1\cdots p_n)-1$，可知$K$不整除$2,3$和$p_i$，故$K$没有形如$6k-1$的素因子，因为形如$6k$、$6k+2$（$2$除外）、$6k+3$（$3$除外）和$6k+4$的数必定是合数，又因为$(6k+1)\mathrm{mod}6=1$，即$(6k+1)^\alpha\mathrm{mod}6=1$，但$K\mathrm{mod}6=5$，故$K$没有素因子，即$K$也是素数，则形如$6k-1$的素数有无穷多个。<br>
> &emsp;&emsp;&emsp;(3) 假设形如$3k-1$的正整数没有同样形式的素因子，由于$(3k-1)\mathrm{mod}3=2$，故不被$3$整除，由于形如$3k$的正整数除了$3$外均为合数，故形如$3k-1$的正整数也没有形式为$3k$的素因子，故其仅有形如$3k+1$的素因子，但由于$(3k+1)^\alpha\mathrm{mod}3=1$，矛盾。则形如$3k-1$的正整数有同样形式的素因子。<br>
> &emsp;&emsp;&emsp;&emsp; 假设形如$4k-1$的正整数没有同样形式的素因子，由于$4k-1$不被$2$整除，形如$4k$和$4k+2$的正整数除了$2$外均为合数，故其只有形如$4k+1$的素因子，但$(4k+1)^\alpha\mathrm{mod}4=1$，与$(4k-1)\mathrm{mod}4=3$矛盾。则形如$4k-1$的正整数有同样形式的素因子。<br>
> &emsp;&emsp;&emsp;&emsp; 假设形如$6k-1$的正整数没有同样形式的素因子，由于$6k-1$不被$2$和$3$整除，形如$6k$、$6k+2$、$6k+3$和$6k+4$的正整数除了$2$和$3$外均为合数，故其只有形如$6k+1$的素因子，但$(6k+1)^\alpha\mathrm{mod}6=1$，与$(6k-1)\mathrm{mod}6=5$矛盾。则形如$6k-1$的正整数有同样形式的素因子。
